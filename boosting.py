...
# read data
def loadData():
    train_df = pd.read_csv(train_dir,sep='\t', header=None, names=['label','q1','q2','id'],nrows =50000)
...
def train(train_X, train_y, para):
    ...
    clf = AdaBoostClassifier(n_estimators=para['n_estimators'], learning_rate=para['lr'])
